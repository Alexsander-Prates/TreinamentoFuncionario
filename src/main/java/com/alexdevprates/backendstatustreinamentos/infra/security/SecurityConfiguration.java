    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST,"/autenticacao/login").permitAll()//qualquer usuario post
                        .requestMatchers(HttpMethod.POST,"/autenticacao/registrar").permitAll() //mudar para .hasRole("ADMIN")
